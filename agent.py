...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        #self.Q = {action: 10 for action in self.valid_actions} #dict()          
        self.Q = dict()
    ...
    def reset(self, destination=None, testing=True):
        ...
        if testing == True:
           ...
           self.epsilon = float(1) / math.exp(float(self.a * self.trials))
    ...
    def get_maxQ(self, state):
        ...
        max_Q = max(self.Q[self.state], key=(lambda key: self.Q[self.state][key]))
        maxQ = self.Q[self.state][max_Q]
    ...
    def createQ(self, state):
        ...
        if (self.learning) and (state not in self.Q):
            #self.Q [self.state]= {'left':0.0, 'right':0.0, 'forward':0.0, None:0.0}
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, alpha=0.25) #, learning=True, alpha=0.25
    ...
    sim.run(n_test= 10, tolerance=0.000005) 
